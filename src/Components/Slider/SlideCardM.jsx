...
const SlideCardM = ({data}) => {
    return (
        <div className=' tracking-wider  flex h-full w-[100%] justify-center gap-[2rem] items-center ' >
           <div className=' text-left flex flex-col w-[60%] h-[80%] gap-4  p-[.5rem]  ' >
            ...
            <div className=' flex justify-between  items-center ' >
                ...
                <div className=' text-[#D3DDDD] buttonBlur cursor-pointer shadow-md p-[.3rem] rounded-[5px] flex gap-0 items-center text-xs ' >
                    <p>Add to cart</p>
           ...
           <div className=' flex flex-col w-[40%] justify-center items-center  '>
            <img className=' rounded-[10px] slideImage w-[8rem] mix-blend-color-burn '  src={data?.image} alt=""/>
           </div>
